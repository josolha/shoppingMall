...
private int viewPage; // 현재 보고있는 페이지
@Builder.Default private int blockSize = 5; 
...
private int cntPerPage;// 페이지별 게시글 수
...
public String toString() {
	return "ProductViewDTO [spec=" + spec + ", cate_code=" + cate_code + ", cate_name=" + cate_name + ", product="
			+ product + ", viewPage=" + viewPage + ", blockSize=" + blockSize + ", blockNum=" + blockNum
			+ ", blockStart=" + blockStart + ", blockEnd=" + blockEnd + ", prevPage=" + prevPage + ", nextPage="
			+ nextPage + ", totalPage=" + totalPage + ", totalCnt=" + totalCnt + ", startIndex=" + startIndex
			+ ", cntPerPage=" + cntPerPage + ", startRowNum=" + startRowNum + ", searchType=" + searchType
			+ ", keyWord=" + keyWord + "]";
}
}
